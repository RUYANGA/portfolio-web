...
const Hero: React.FC = () => {
  ...
  const fullText = "Full Stack Enginneer";
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col justify-center relative bg-gradient-to-r from-blue-50 to-gray-50"
    >
      <div className="container mx-auto px-4 lg:px-8 pt-20 pb-16">
        <div className="max-w-4xl mx-auto">
          <p className="text-blue-600 font-medium mb-2 opacity-0 animate-fade-in">
            Hello, I'm
          </p>
          ...
          <h2 className="text-2xl md:text-4xl font-light text-gray-700 mb-8 h-10">
            <span className="relative">
              ...
              {!isComplete && (
                <span className="inline-block w-1 h-8 bg-blue-600 ml-1 animate-blink"></span>
              )}
            </span>
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mb-10 opacity-0 animate-fade-in-delayed">
            Full Stack Developer with 3+ years of
            experience in designing, building, and deploying modern web
            applications using a wide range of frontend and backend
            technologies. Skilled at creating clean, scalable APIs, efficient
            databases, and responsive UIs. Passionate about crafting
            high-performance full-stack solutions and improving user experience
